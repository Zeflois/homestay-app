...
@section('heading', 'Sunting Halaman Galeri Foto')
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="photo_gallery_status" class="form-control">
                                        <option value="1" @if($page_data->photo_gallery_status == 1) selected @endif>Tunjukan</option>
                                        <option value="0" @if($page_data->photo_gallery_status == 0) selected @endif>Sembunyikan</option>
                                    </select>
                                </div>
                                <div class="mb-4">

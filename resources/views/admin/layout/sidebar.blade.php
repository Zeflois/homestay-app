                ...
                <ul class="sidebar-menu">
                    ...
                    <!-- <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a class="nav-link" href="{{ route('admin_slide_view') }}"><i class="fa fa-angle-right"></i> Item 1</a></li>
                    ...
                    <li class=""><a class="nav-link" href="{{ route('admin_feature_view') }}"><i class="fa fa-hand-o-right"></i> <span>Form</span></a></li>
